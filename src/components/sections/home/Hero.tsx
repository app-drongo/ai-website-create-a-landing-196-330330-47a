        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Streamline operations, reduce costs, and accelerate growth with our enterprise-grade
              SAP ERP integration solutions. Trusted by Fortune 500 companies worldwide.
            </p>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="SAP ERP dashboard interface showing real-time business analytics and integration workflows"
                  fill
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">40%</span> faster deployment
              </p>
            </div>
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">65%</span> operational savings
              </p>
            </div>
          </div>
        </div>
